...
import 'package:flutter_bzaru/ui/pages/business/help/b_get_help.dart';
import 'package:flutter_bzaru/ui/pages/personal/help/c_get_help.dart';
import 'package:flutter_bzaru/ui/theme/themes.dart';
import 'package:flutter_bzaru/ui/widgets/widgets.dart';
import 'package:provider/provider.dart';

class BHelp extends StatefulWidget {
  @override
  _BHelpState createState() => _BHelpState();
}

class _BHelpState extends State<BHelp> {
  ...
  Widget _buildNeedHelp(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        Row(
          children: [
            Icon(Icons.phone, color: KColors.businessPrimaryColor, size: 23),
            SizedBox(width: 5.0),
            BText(
              "1.844.981.3433",
              variant: TypographyVariant.h1,
  ...
  Widget _buildButton(BuildContext context) {
    ...
    return BFlatButton(
      ...
      onPressed: () {
        Navigator.push(
            context, CupertinoPageRoute(builder: (context) => BGetHelp()));
      },
    );
  }
