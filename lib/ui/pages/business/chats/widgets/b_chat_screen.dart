...
class BChatScreen extends StatefulWidget {
  ...
  const BChatScreen({Key key, this.ordersModel, this.chatMessageModel})
      : super(key: key);
  ...
  @override
  _BChatScreenState createState() => _BChatScreenState();
}
...
class _BChatScreenState extends State<BChatScreen> {
  ...
  void initState() {
    ...
    chatState.setChatUser = ProfileModel(
      id: widget.ordersModel?.customerId ?? widget.chatMessageModel?.receiverId,
      name: widget.ordersModel?.mainCustomerName ??
    ...
    chatState.databaseInit(
      widget.ordersModel?.customerId ?? widget.chatMessageModel?.receiverId,
      widget.ordersModel?.merchantId ?? widget.chatMessageModel?.senderId,
    );
  ...
  void submitMessage() {
    ...
    message = ChatMessage(
      ...
      receiverName: widget.ordersModel?.mainCustomerName ??
          widget.chatMessageModel?.receiverName,
      receiverImage: widget.ordersModel?.customerProfileImage ??
    ...
    Provider.of<ChatState>(context, listen: false).getChatsForMerchant();
      ...
      child: Scaffold(
        ...
        appBar: BAppBar(
          title: widget.ordersModel != null
              ? widget.ordersModel?.mainCustomerName
              : widget.chatMessageModel?.receiverName ??
